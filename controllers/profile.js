    ...
    return {
        ...
        getProfilePage: function(req, res){
            async.parallel([
                ...
                res.render('user/profile', {title: 'MeetUp - Profile', user:req.user, data: result1, chat:result2});
            });
        },
        ...
        overviewPage: function(req, res){
            async.parallel([
                ...
                res.render('user/overview', {title: 'MeetUp - Overview', user:req.user, data: result1, chat:result2});
            });
        },
