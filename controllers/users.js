...
module.exports = function(_, passport, validator){
    ...
    return {
        ...
        indexPage: function(req, res){
            ...
            return res.render('index', {title: 'MeetUp | Login', messages: errors, hasErrors: errors.length > 0});
        },
        ...
        getSignUp: function(req, res){
            const errors = req.flash('error');
            return res.render('signup', {title: 'MeetUp | SignUp', messages: errors, hasErrors: errors.length > 0});
        },
